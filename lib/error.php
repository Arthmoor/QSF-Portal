...
function error_fatal($type, $message, $file, $line = 0)
{
	...
	if ($type != QUICKSILVER_QUERY_ERROR) {
		if (strpos($message, 'mysql_fetch_array(): supplied argument') === false) {
			...
			$details2 = "
			<span class='header'>MySQL Said:</span><br />\n" . mysql_error() . '<br />\n';
		}
		...
		<br /><br />\n\n<span class='header'>Query:</span><br />\n$file<br />\n";
	}
	...
	<br /><hr><br />
	<a href='http://www.qsfportal.com/index.php?a=forum&amp;f=6' class='small'>Check status of problem (recommended)</a><br />
