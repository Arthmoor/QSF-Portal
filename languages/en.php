...
class en
{
   ...
   public $quote;
   public $recount_forums;
   public $reply;
   public $seconds;
   public $select_all;
   public $sep_decimals;
   public $sep_thousands;
   public $spam;
   public $spoiler;
   public $submit;
   public $subscribe;
   ...
   public $active_last_action;
   public $active_modules_active;
   public $active_modules_board;
   public $active_modules_cp;
   public $active_modules_file_rating;
   public $active_modules_files;
   public $active_modules_forum;
   public $active_modules_login;
   public $active_modules_members;
   public $active_modules_mod;
   public $active_modules_newspost;
   public $active_modules_pages;
   public $active_modules_pm;
   public $active_modules_post;
   public $active_modules_profile;
   public $active_modules_recent;
   public $active_modules_search;
   public $active_modules_topic;
   public $active_time;
   public $active_user;
   public $active_users;

   public $admin_add_member_titles;
   public $admin_akismet_api_key_test;
   public $admin_ban_ips;
   public $admin_censor;
   public $admin_cp_denied;
   public $admin_cp_warning;
   public $admin_create_forum;
   public $admin_create_group;
   public $admin_create_help;
   public $admin_create_skin;
   public $admin_db;
   public $admin_db_backup;
   public $admin_db_optimize;
   public $admin_db_query;
   public $admin_db_repair;
   public $admin_db_restore;
   public $admin_delete_forum;
   public $admin_delete_group;
   public $admin_delete_help;
   public $admin_delete_member;
   public $admin_edit_forum;
   public $admin_edit_group_file_perms;
   public $admin_edit_group_name;
   public $admin_edit_group_perms;
   public $admin_edit_help;
   public $admin_edit_member;
   public $admin_edit_member_file_perms;
   public $admin_edit_member_perms;
   public $admin_edit_member_titles;
   public $admin_edit_settings;
   public $admin_edit_skin;
   public $admin_emojis;
   public $admin_export_skin;
   public $admin_fix_stats;
   public $admin_forum_order;
   public $admin_forums;
   public $admin_groups;
   ...
   public $admin_settings_add;
   public $admin_skins;
   public $admin_stats;
   public $admin_your_board;
   public $admin_new_captcha;
   public $admin_list_captcha;

   public $backup;
   public $backup_add;
   public $backup_add_complete;
   public $backup_create;
   public $backup_created;
   public $backup_createfile;
   public $backup_done;
   public $backup_download;
   public $backup_failed;
   public $backup_found;
   public $backup_import_fail;
   public $backup_invalid;
   public $backup_no_packages;
   public $backup_noexist;
   public $backup_none;
   public $backup_options;
   public $backup_restore;
   public $backup_restore_done;
   public $backup_statements;
   public $backup_uncheck;
   public $backup_warning;

   public $ban;
   public $ban_banned_ips;
   public $ban_banned_members;
   public $ban_cidr;
   public $ban_ip;
   public $ban_member_explain1;
   public $ban_member_explain2;
   public $ban_members;
   public $ban_nomembers;
   public $ban_one_per_line;
   public $ban_regex_allowed;
   public $ban_settings;
   ...
   public $board_mark;
   public $board_mark1;
   public $board_markforum;
   public $board_markforum1;
   ...
   public $board_nopost;
   public $board_noview;
   public $board_regfirst;
   public $board_replies;
   public $board_stats;
   public $board_stats_string;
   public $board_top_page;
   public $board_topics;
   public $board_unread;
   public $board_users;
   public $board_write_topics;

   public $censor;
   public $censor_one_per_line;
   public $censor_regex_allowed;
   public $censor_updated;

   public $cv_conversations;
   public $cv_akismet_posts_spam;
   public $cv_attach;
   public $cv_attach_add;
   public $cv_attach_disrupt;
   public $cv_attach_failed;
   public $cv_attached_image;
   public $cv_attach_not_allowed;
   public $cv_attach_remove;
   public $cv_attach_too_large;
   public $cv_attached;
   public $cv_attached_downloads;
   public $cv_attached_filename;
   public $cv_attached_size;
   public $cv_bottom;
   public $cv_by;
   public $cv_cannot_invite;
   public $cv_cannot_send;
   public $cv_cant_reply;
   public $cv_edited;
   public $cv_error;
   public $cv_error_invite;
   public $cv_flood;
   public $cv_group;
   public $cv_guest;
   public $cv_guest_user;
   public $cv_icon;
   public $cv_invite;
   public $cv_invite_others;
   public $cv_invited;
   public $cv_joined;
   public $cv_jump;
   public $cv_last;
   ...
   public $cv_new_post;
   public $cv_no_convos;
   public $cv_no_message;
   public $cv_no_recipients;
   public $cv_no_title;
   public $cv_not_found_message;
   public $cv_no_newer;
   public $cv_no_older;
   public $cv_old_pmsystem;
   public $cv_older;
   public $cv_offline;
   public $cv_online;
   public $cv_option_emojis;
   public $cv_option_bbcode;
   public $cv_options;
   public $cv_pages;
   public $cv_participants;
   public $cv_post;
   public $cv_posted;
   public $cv_posting;
   public $cv_posts;
   public $cv_preview;
   public $cv_private_conversations;
   public $cv_quickreply;
   public $cv_quote;
   public $cv_replies;
   public $cv_reply;
   public $cv_reply_topic;
   public $cv_replying;
   public $cv_sent_invite;
   public $cv_sent_mail;
   public $cv_sent_reply;
   public $cv_separate_names;
   public $cv_started;
   public $cv_starter;
   public $cv_title;
   public $cv_to;
   public $cv_top;
   public $cv_topic;
   public $cv_topic_posted;
   public $cv_unread;
   public $cv_unreg;
   public $cv_users;
   public $cv_view_topic;
   public $cv_views;
   public $cv_viewing;

   public $cp_already_member;
   public $cp_apr;
   public $cp_aug;
   public $cp_avatar_current;
   public $cp_avatar_error;
   public $cp_avatar_gravatar;
   public $cp_avatar_must_select;
   public $cp_avatar_none;
   public $cp_avatar_pixels;
   public $cp_avatar_select;
   public $cp_avatar_size_height;
   public $cp_avatar_size_width;
   public $cp_avatar_upload;
   public $cp_avatar_upload_failed;
   public $cp_avatar_upload_not_image;
   public $cp_avatar_upload_too_large;
   ...
   public $cp_changing_email;
   public $cp_changing_pass;
   public $cp_contact_pm;
   public $cp_contact_pm_email;
   public $cp_cp;
   public $cp_current_avatar;
   public $cp_current_time;
   public $cp_custom_title;
   public $cp_custom_title2;
   public $cp_dec;
   public $cp_editing_avatar;
   public $cp_editing_profile;
   public $cp_email;
   public $cp_email_form;
   public $cp_email_invaid;
   public $cp_err_avatar;
   public $cp_err_updating;
   public $cp_facebook;
   public $cp_feb;
   public $cp_file_type;
   public $cp_format;
   ...
   public $cp_july;
   public $cp_june;
   public $cp_label_edit_avatar;
   public $cp_label_edit_pass;
   public $cp_label_edit_prefs;
   public $cp_label_edit_profile;
   public $cp_label_edit_sig;
   public $cp_label_edit_sig_spam;
   public $cp_label_edit_subs;
   public $cp_language;
   public $cp_less_charac;
   public $cp_location;
   public $cp_login_first;
   public $cp_mar;
   public $cp_may;
   public $cp_must_orig;
   public $cp_new_notmatch;
   public $cp_new_pass;
   public $cp_no_edit_avatar;
   public $cp_no_edit_profile;
   public $cp_no_edit_sig;
   public $cp_no_flash;
   public $cp_not_exist;
   public $cp_nov;
   public $cp_oct;
   public $cp_old_notmatch;
   public $cp_old_pass;
   public $cp_pass;
   public $cp_pass2;
   public $cp_pass_notmatch;
   public $cp_pass_notvaid;
   public $cp_posts_page;
   public $cp_preferences;
   public $cp_preview_sig;
   public $cp_privacy;
   public $cp_profile_spam;
   public $cp_repeat_pass;
   public $cp_sept;
   public $cp_show_active;
   public $cp_show_email;
   public $cp_signature;
   public $cp_size_max;
   public $cp_skin;
   public $cp_sub_change;
   public $cp_sub_delete;
   public $cp_sub_expire;
   public $cp_sub_name;
   public $cp_sub_no_params;
   public $cp_sub_success;
   public $cp_sub_type;
   public $cp_sub_updated;
   public $cp_topic_option;
   public $cp_topics_page;
   public $cp_twitter;
   public $cp_updated;
   public $cp_updated1;
   public $cp_updated_prefs;
   public $cp_user_exists;
   public $cp_valided;
   public $cp_view_avatar;
   public $cp_view_emoji;
   public $cp_view_signature;
   public $cp_welcome;
   public $cp_width;
   public $cp_www;
   public $cp_zone;
   ...
   public $email_akismet_email_spam;
   public $email_blocked;
   public $email_email;
   public $email_msgtext;
   public $email_no_fields;
   public $email_no_member;
   public $email_no_perm;
   public $email_sent;
   ...
   public $emoji_added;
   public $emoji_back;
   public $emoji_clickable;
   public $emoji_controls;
   public $emoji_edit_or_delete;
   public $emoji_image;
   public $emoji_invalid_image;
   public $emoji_image_failed;
   public $emoji_no_text;
   public $emoji_text;

   public $file;
   public $files;
   public $files_action_not_allowed;
   public $files_action_not_permitted;
   public $files_add_cat;
   public $files_add_cat_desc;
   public $files_add_cat_done;
   public $files_add_cat_exists;
   public $files_add_cat_name;
   public $files_add_cat_not_allowed;
   public $files_add_cat_parent;
   public $files_add_cat_qperms;
   public $files_add_cat_qperms2;
   public $files_add_mod;
   public $files_add_mod2;
   public $files_add_mod_cat;
   public $files_add_mod_made;
   public $files_add_mod_not_allowed;
   public $files_add_mod_nouser;
   public $files_added;
   public $files_all_fields_required;
   public $files_approval_not_permitted;
   public $files_approval_waiting;
   public $files_approve;
   public $files_approve2;
   public $files_approve_error;
   public $files_approve_none;
   public $files_approved;
   public $files_author;
   public $files_cat;
   public $files_cat_edited;
   public $files_cat_exists;
   public $files_close_window;
   public $files_comment;
   public $files_comment_empty;
   public $files_comment_not_permitted;
   public $files_comment_posted;
   public $files_comment_specify;
   public $files_comment_user;
   public $files_comment_view;
   public $files_comments;
   public $files_delete_cat;
   public $files_delete_cat2;
   public $files_delete_cat_done;
   public $files_delete_cat_not_empty;
   public $files_delete_cat_not_exist;
   public $files_delete_cat_not_permitted;
   public $files_delete_confirm;
   public $files_delete_file;
   public $files_delete_file_done;
   public $files_delete_file_not_permitted;
   public $files_delete_file_specify;
   public $files_delete_nocat;
   public $files_delete_root;
   public $files_denied;
   public $files_deny;
   public $files_desc;
   public $files_dl;
   public $files_download;
   public $files_download_not_permitted;
   public $files_download_specify;
   public $files_downloads;
   public $files_downloads2;
   public $files_edit_cat_not_parent;
   public $files_edit_cat_not_permitted;
   public $files_edit_category;
   public $files_edit_file;
   public $files_edit_mod;
   public $files_edit_not_permitted;
   public $files_edit_root;
   public $files_error_duplicate;
   public $files_error_trick;
   public $files_error_unknown;
   public $files_exists;
   public $files_fix_stats;
   public $files_fix_stats2;
   public $files_has_updated;
   public $files_index;
   public $files_invalid_category;
   public $files_invalid_file;
   public $files_invalid_option;
   public $files_invalid_user;
   public $files_moderator;
   public $files_modify_info;
   public $files_move;
   public $files_move_category;
   public $files_move_file;
   public $files_move_no_category;
   public $files_move_not_permitted;
   public $files_moved_file;
   public $files_name;
   public $files_rate;
   public $files_rate_already;
   public $files_rate_average;
   public $files_rate_excellent;
   public $files_rate_good;
   public $files_rate_please;
   public $files_rate_poor;
   public $files_rate_sucks;
   public $files_rate_thank;
   public $files_rate_valid;
   public $files_rating;
   public $files_recent;
   public $files_recent_uploads;
   public $files_recent_uploads_none;
   public $files_remove_mod;
   public $files_remove_mod_cat;
   public $files_remove_mod_done;
   public $files_remove_mod_not_permitted;
   public $files_revised;
   public $files_revisions;
   public $files_search;
   public $files_search2;
   public $files_search3;
   public $files_search_advanced;
   public $files_search_basic;
   public $files_search_by;
   public $files_search_day;
   public $files_search_days;
   public $files_search_display_first;
   public $files_search_display_more;
   public $files_search_error;
   public $files_search_error_something;
   public $files_search_error_none;
   public $files_search_for;
   public $files_search_in;
   public $files_search_minimum_rating;
   public $files_search_month;
   public $files_search_months;
   public $files_search_newer;
   public $files_search_older;
   public $files_search_results;
   public $files_search_results2;
   public $files_search_than;
   public $files_search_week;
   public $files_search_weeks;
   public $files_search_year;
   public $files_size;
   public $files_submitted_by;
   public $files_top20;
   public $files_type;
   public $files_update;
   public $files_update_approval_not_permitted;
   public $files_update_approve;
   public $files_update_approve_failed;
   public $files_update_approved;
   public $files_update_denied;
   public $files_update_deny;
   public $files_update_desc;
   public $files_update_exists;
   public $files_update_file;
   public $files_update_file_need_desc;
   public $files_update_not_exist;
   public $files_update_not_exist2;
   public $files_update_not_permitted;
   public $files_update_pending;
   public $files_updated;
   public $files_upload;
   public $files_upload_no_root;
   public $files_upload_not_permitted;
   public $files_upload_pending;
   public $files_upload_rules;
   public $files_uploaded;
   public $files_version;
   public $files_view;
   public $files_view_archive;
   public $files_view_c;
   public $files_view_category;
   public $files_view_cat_not_permitted;
   public $files_view_cpp;
   public $files_view_java;
   public $files_view_perl;
   public $files_view_php;
   public $files_view_plain;
   public $files_view_python;
   public $files_view_specify;

   public $forum_by;
   public $forum_can_post;
   public $forum_can_topics;
   public $forum_cant_post;
   public $forum_cant_topics;
   public $forum_dot;
   public $forum_dot_detail;
   public $forum_forum;
   public $forum_forum_url;
   public $forum_guest;
   public $forum_hot;
   public $forum_icon;
   public $forum_jump;
   public $forum_last;
   public $forum_locked;
   public $forum_mark_read;
   public $forum_moved;
   public $forum_msg;
   public $forum_new;
   public $forum_new_poll;
   public $forum_new_topic;
   public $forum_no_topics;
   public $forum_noexist;
   public $forum_nopost;
   public $forum_not;
   public $forum_noview;
   public $forum_pages;
   public $forum_pinned;
   public $forum_pinned_topic;
   public $forum_poll;
   public $forum_regfirst;
   public $forum_replies;
   public $forum_starter;
   public $forum_sub;
   public $forum_sub_last_post;
   public $forum_sub_replies;
   public $forum_sub_topics;
   public $forum_subscribe;
   public $forum_topic;
   public $forum_topic_posted;
   public $forum_unread;
   public $forum_views;
   public $forum_write_topics;

   public $forum_controls;
   public $forum_create;
   public $forum_create_cat;
   public $forum_created;
   public $forum_default_perms;
   public $forum_delete;
   public $forum_delete_warning;
   public $forum_deleted;
   public $forum_description;
   public $forum_edit;
   public $forum_edited;
   public $forum_empty;
   public $forum_is_news;
   public $forum_is_subcat;
   public $forum_is_url;
   public $forum_name;
   public $forum_news;
   public $forum_news_error;
   public $forum_no_orphans;
   public $forum_none;
   public $forum_ordered;
   public $forum_ordering;
   public $forum_parent;
   public $forum_parent_cat;
   public $forum_quickperm_select;
   public $forum_quickperms;
   public $forum_recount;
   public $forum_select_cat;
   public $forum_subcat;
   public $forum_url;

   public $groups_bad_format;
   public $groups_based_on;
   public $groups_controls;
   public $groups_create;
   public $groups_create_new;
   public $groups_created;
   public $groups_delete;
   public $groups_deleted;
   public $groups_edit;
   public $groups_edited;
   public $groups_formatting;
   public $groups_i_confirm;
   public $groups_name;
   public $groups_no_action;
   public $groups_no_delete;
   public $groups_no_group;
   public $groups_no_name;
   public $groups_only_custom;
   public $groups_the;
   public $groups_to_edit;
   public $groups_type;
   public $groups_will_be;
   public $groups_will_become;

   public $home_choose;
   public $home_menu_title;

   public $login;
   public $login_cant_logged;
   public $login_cookies;
   public $login_did_not_request;
   public $login_did_request;
   public $login_forgot_pass;
   public $login_header;
   public $login_logged;
   public $login_now_out;
   public $login_out;
   public $login_pass;
   public $login_pass_no_id;
   public $login_pass_request;
   public $login_pass_reset;
   public $login_pass_sent;
   public $login_request_done;
   public $login_request_done2;
   public $login_request_ip;
   public $login_someome_requested;
   public $login_sure;
   public $login_user;

   public $logs_action;
   public $logs_category;
   public $logs_category_created;
   public $logs_category_deleted;
   public $logs_category_edited;
   public $logs_category_from;
   public $logs_category_in;
   public $logs_deleted_post;
   public $logs_deleted_topic;
   public $logs_edited_post;
   public $logs_edited_topic;
   public $logs_file;
   public $logs_file_deleted;
   public $logs_file_edited;
   public $logs_file_moved;
   public $logs_file_update_approved;
   public $logs_file_update_denied;
   public $logs_file_updated;
   public $logs_id;
   public $logs_locked_topic;
   public $logs_mod_add;
   public $logs_mod_remove;
   public $logs_moved_from ;
   public $logs_moved_to;
   public $logs_moved_topic;
   public $logs_moved_topic_num;
   public $logs_pinned_topic;
   public $logs_post;
   public $logs_published_topic;
   public $logs_reported_spam;
   public $logs_time;
   public $logs_topic;
   public $logs_unlocked_topic;
   public $logs_unpinned_topic;
   public $logs_unpublished_topic;
   public $logs_user;
   public $logs_view;

   public $mail;
   public $mail_announce;
   public $mail_groups;
   public $mail_members;
   public $mail_message;
   public $mail_select_all;
   public $mail_send;
   public $mail_sent;
   public $mail_subject;

   public $main_activate;
   public $main_activate_resend;
   public $main_admincp;
   public $main_affiliates;
   public $main_banned;
   public $main_code;
   public $main_conversations;
   public $main_cp;
   public $main_files;
   public $main_forum;
   public $main_forum_rules;
   public $main_full;
   public $main_guests;
   public $main_help;
   public $main_home;
   ...
   public $main_mark;
   public $main_mark1;
   public $main_markforum_read;
   public $main_member_newest;
   public $main_members;
   public $main_messenger;
   public $main_new;
   public $main_news;
   public $main_next;
   public $main_pages;
   public $main_posted_by;
   public $main_posts;
   public $main_prev;
   public $main_queries;
   public $main_quote;
   public $main_recent;
   public $main_recent1;
   public $main_recent_uploads;
   public $main_register;
   public $main_reminder;
   public $main_reminder_closed;
   public $main_said;
   public $main_search;
   public $main_spam_controls;
   public $main_stats;
   public $main_top_posters;
   public $main_top_uploaders;
   public $main_topics;
   public $main_topics_new;
   ...
   public $main_welcome;
   public $main_welcome_guest;

   public $mc;
   public $mc_confirm;
   public $mc_confirm_bot;
   public $mc_delete;
   public $mc_deleted;
   public $mc_edit;
   public $mc_edited;
   public $mc_email_invaid;
   public $mc_err_updating;
   public $mc_find;
   public $mc_found;
   public $mc_guest_banned;
   public $mc_guest_needed;
   public $mc_not_found;
   public $mc_report_spambot;
   public $mc_user_avatar;
   ...
   public $mc_user_homepage;
   public $mc_user_id;
   public $mc_user_interests;
   public $mc_user_joined;
   public $mc_user_language;
   public $mc_user_lastpost;
   public $mc_user_lastvisit;
   public $mc_user_level;
   public $mc_user_location;
   public $mc_user_name;
   public $mc_user_pm;
   public $mc_user_pm_mail;
   public $mc_user_posts;
   public $mc_user_regemail;
   public $mc_user_regip;
   public $mc_user_server_data;
   public $mc_user_signature;
   public $mc_user_skin;
   public $mc_user_timezone;
   public $mc_user_title;
   public $mc_user_title_custom;
   public $mc_user_uploads;
   public $mc_user_view_avatars;
   public $mc_user_view_emojis;
   public $mc_user_view_signatures;

   public $mcount;
   public $mcount_updated;

   public $members_all;
   public $members_email;
   public $members_email_member;
   public $members_group;
   public $members_joined;
   public $members_list;
   public $members_member;
   public $members_pm;
   public $members_posts;
   public $members_send_pm;
   public $members_title;
   public $members_visit_facebook;
   public $members_visit_twitter;
   public $members_visit_www;
   public $members_www;

   public $mod_confirm_post_delete;
   public $mod_confirm_post_delete_spam;
   public $mod_confirm_topic_delete;
   public $mod_delete_post_locked;
   public $mod_edit_post_locked;
   public $mod_edit_post_old;
   public $mod_error_first_post;
   public $mod_error_move_category;
   public $mod_error_move_create;
   public $mod_error_move_forum;
   public $mod_error_move_global;
   public $mod_error_move_same;
   public $mod_ip_view;
   public $mod_ip_view_no_user;
   public $mod_ip_view_not_allowed;
   public $mod_ip_view_posted;
   public $mod_label_controls;
   public $mod_label_description;
   public $mod_label_emoji;
   public $mod_label_global;
   public $mod_label_bbcode;
   public $mod_label_move_to;
   public $mod_label_options;
   public $mod_label_post_delete;
   public $mod_label_post_edit;
   public $mod_label_post_icon;
   public $mod_label_publish;
   public $mod_label_title;
   public $mod_label_title_original;
   public $mod_label_title_split;
   public $mod_label_topic_delete;
   public $mod_label_topic_edit;
   public $mod_label_topic_lock;
   public $mod_label_topic_move;
   public $mod_label_topic_move_complete;
   public $mod_label_topic_move_link;
   public $mod_label_topic_pin;
   public $mod_label_topic_split;
   public $mod_missing_post;
   public $mod_missing_topic;
   public $mod_no_action;
   public $mod_no_post;
   public $mod_no_topic;
   public $mod_perm_post_delete;
   public $mod_perm_post_edit;
   public $mod_perm_publish;
   public $mod_perm_topic_delete;
   public $mod_perm_topic_edit;
   public $mod_perm_topic_lock;
   public $mod_perm_topic_move;
   public $mod_perm_topic_pin;
   public $mod_perm_topic_split;
   public $mod_perm_topic_unlock;
   public $mod_perm_topic_unpin;
   public $mod_success_post_delete;
   public $mod_success_post_edit;
   public $mod_success_publish;
   public $mod_success_split;
   public $mod_success_topic_delete;
   public $mod_success_topic_edit;
   public $mod_success_topic_move;
   public $mod_success_unpublish;
   
   public $news_comments;
   public $news_more;
   public $news_previous;

   public $newspost_comments;
   public $newspost_news;
   public $newspost_no_article;
   public $newspost_post_comment;
   public $newspost_post_emojis;
   public $newspost_post_bbcode;

   public $optimize;
   public $optimized;

   public $page;
   public $page_action_not_allowed;
   public $page_contents;
   public $page_create;
   public $page_create2;
   public $page_create_not_permitted;
   public $page_created;
   public $page_creating;
   public $page_delete;
   public $page_delete_confirm;
   public $page_delete_not_permitted;
   public $page_deleted;
   public $page_edit;
   public $page_edit_done;
   public $page_edit_not_permitted;
   public $page_editing;
   public $page_format_bbcode;
   public $page_format_breaks;
   public $page_format_censor;
   public $page_format_emojis;
   public $page_format_html;
   public $page_not_exist;
   public $page_title;
   public $page_viewing;
   public $pages;
   public $pages_none;
   ...
   public $perm;
   public $perms;
   public $perms_board_view;
   public $perms_board_view_closed;
   public $perms_create_pages;
   public $perms_delete_pages;
   public $perms_do_anything;
   public $perms_edit_avatar;
   public $perms_edit_for;
   public $perms_edit_pages;
   public $perms_edit_profile;
   public $perms_edit_sig;
   public $perms_email_use;
   public $perms_for;
   public $perms_forum;
   public $perms_forum_view;
   public $perms_global;
   public $perms_group;
   public $perms_guest1;
   public $perms_guest2;
   public $perms_is_admin;
   public $perms_only_user;
   public $perms_override_user;
   public $perms_pm_noflood;
   public $perms_poll_create;
   public $perms_poll_vote;
   public $perms_post_attach;
   public $perms_post_attach_download;
   public $perms_post_create;
   public $perms_post_delete;
   public $perms_post_delete_old;
   public $perms_post_delete_own;
   public $perms_post_edit;
   public $perms_post_edit_old;
   public $perms_post_edit_own;
   public $perms_post_inc_userposts;
   public $perms_post_noflood;
   public $perms_post_viewip;
   public $perms_search_noflood;
   public $perms_title;
   public $perms_topic_create;
   public $perms_topic_delete;
   public $perms_topic_delete_own;
   public $perms_topic_edit;
   public $perms_topic_edit_own;
   public $perms_topic_global;
   public $perms_topic_lock;
   public $perms_topic_lock_own;
   public $perms_topic_move;
   public $perms_topic_move_own;
   public $perms_topic_pin;
   public $perms_topic_pin_own;
   public $perms_topic_publish;
   public $perms_topic_publish_auto;
   public $perms_topic_split;
   public $perms_topic_split_own;
   public $perms_topic_unlock;
   public $perms_topic_unlock_own;
   public $perms_topic_unpin;
   public $perms_topic_unpin_own;
   public $perms_topic_view;
   public $perms_topic_view_unpublished;
   public $perms_update;
   public $perms_updated;
   public $perms_user;
   public $perms_user_inherit;

   public $php_error;
   public $php_error_msg;

   public $pm_avatar;
   public $pm_cant_del;
   public $pm_delallmsg;
   public $pm_delete;
   public $pm_delete_selected;
   public $pm_deleted;
   public $pm_deleted_all;
   public $pm_error;
   public $pm_fields;
   public $pm_flood;
   public $pm_folder_inbox;
   public $pm_folder_new;
   public $pm_folder_sentbox;
   public $pm_from;
   public $pm_group;
   public $pm_guest;
   public $pm_joined;
   public $pm_mark_unread;
   public $pm_messenger;
   public $pm_msgtext;
   public $pm_multiple;
   public $pm_no_folder;
   ...
   public $pm_online;
   public $pm_personal;
   public $pm_personal_msging;
   public $pm_pm;
   public $pm_posts;
   public $pm_preview;
   public $pm_recipients;
   public $pm_reply;
   public $pm_send;
   public $pm_sendamsg;
   public $pm_sendingpm;
   ...
   public $pm_success;
   public $pm_sure_del;
   public $pm_sure_delall;
   public $pm_system_disabled;
   public $pm_title;
   public $pm_to;

   public $post_akismet_posts_spam;
   public $post_attach;
   public $post_attach_add;
   public $post_attach_disrupt;
   public $post_attach_failed;
   public $post_attach_not_allowed;
   public $post_attach_remove;
   public $post_attach_too_large;
   public $post_cant_create;
   public $post_cant_create1;
   public $post_cant_enter;
   public $post_cant_poll;
   public $post_cant_poll1;
   public $post_cant_reply;
   public $post_cant_reply1;
   public $post_cant_reply2;
   public $post_closed;
   public $post_create_poll;
   public $post_create_topic;
   public $post_creating;
   public $post_creating_poll;
   public $post_flood;
   public $post_guest;
   public $post_icon;
   public $post_last_five;
   public $post_length;
   public $post_msg;
   public $post_must_msg;
   public $post_must_options;
   public $post_must_title;
   public $post_new_poll;
   public $post_new_topic;
   public $post_no_forum;
   public $post_no_topic;
   public $post_no_vote;
   public $post_option_emojis;
   public $post_option_global;
   public $post_option_lock;
   public $post_option_bbcode;
   public $post_option_pin;
   public $post_optional;
   public $post_options;
   public $post_poll_options;
   public $post_poll_row;
   public $post_posted;
   public $post_posting;
   public $post_preview;
   public $post_reply;
   public $post_reply_topic;
   public $post_replying;
   public $post_replying1;
   public $post_too_many_options;
   public $post_topic_detail;
   public $post_topic_title;
   public $post_view_topic;
   public $post_voting;
   ...
   public $profile_fav;
   public $profile_fav_forum;
   public $profile_info;
   public $profile_interest;
   public $profile_joined;
   public $profile_last_post;
   public $profile_last_visit;
   public $profile_list;
   public $profile_location;
   public $profile_member;
   public $profile_member_title;
   public $profile_must_user;
   public $profile_no_member;
   public $profile_none;
   public $profile_not_post;
   public $profile_offline;
   public $profile_online;
   public $profile_pm;
   public $profile_postcount;
   public $profile_posts;
   public $profile_private;
   public $profile_profile;
   public $profile_signature;
   public $profile_twitter;
   public $profile_unkown;
   public $profile_upload_last;
   public $profile_uploads;
   public $profile_uploads_none;
   public $profile_uploads_none_yet;
   public $profile_uploads_per_day;
   public $profile_uploads_total;
   public $profile_view_profile;
   public $profile_www;

   public $prune_action;
   public $prune_age_day;
   public $prune_age_eighthours;
   public $prune_age_hour;
   public $prune_age_month;
   public $prune_age_threemonths;
   public $prune_age_week;
   public $prune_age_year;
   public $prune_forums;
   public $prune_invalidage;
   public $prune_move;
   public $prune_moveto_forum;
   public $prune_nodest;
   public $prune_notopics;
   public $prune_notopics_old;
   public $prune_novalidforum;
   public $prune_old_topics;
   public $prune_select_age;
   public $prune_select_topics;
   public $prune_success;
   public $prune_title;
   public $prune_topics_older_than;

   public $query;
   public $query_fail;
   public $query_success;
   public $query_your;

   public $recent_active;
   public $recent_by;
   public $recent_can_post;
   public $recent_can_topics;
   public $recent_cant_post;
   public $recent_cant_topics;
   public $recent_dot;
   public $recent_dot_detail;
   public $recent_forum;
   public $recent_guest;
   public $recent_hot;
   public $recent_icon;
   public $recent_jump;
   public $recent_last;
   public $recent_locked;
   public $recent_moved;
   public $recent_msg;
   public $recent_new;
   public $recent_new_poll;
   public $recent_new_topic;
   public $recent_no_topics;
   public $recent_noexist;
   public $recent_nopost;
   public $recent_not;
   public $recent_noview;
   public $recent_pages;
   public $recent_pinned;
   public $recent_pinned_topic;
   public $recent_poll;
   public $recent_regfirst;
   public $recent_replies;
   public $recent_starter;
   public $recent_sub;
   public $recent_sub_last_post;
   public $recent_sub_replies;
   public $recent_sub_topics;
   public $recent_subscribe;
   public $recent_topic;
   public $recent_topic_posted;
   public $recent_views;
   public $recent_write_topics;

   public $register_activated;
   public $register_activating;
   public $register_activation_error;
   public $register_akismet_ureg_spam;
   public $register_confirm_passwd;
   public $register_cookie_required;
   public $register_done;
   public $register_email;
   public $register_email_domain_invalid;
   public $register_email_invalid;
   public $register_email_msg;
   public $register_email_msg2;
   public $register_email_msg3;
   public $register_email_used;
   public $register_fields;
   public $register_flood;
   public $register_image;
   public $register_image_invalid;
   public $register_initiated;
   public $register_math_ask;
   public $register_math_fail;
   public $register_must_activate;
   public $register_name_invalid;
   public $register_name_taken;
   public $register_new_user;
   public $register_pass_invalid;
   public $register_pass_match;
   public $register_passwd;
   public $register_reg;
   public $register_reging;
   public $register_registration_disabled;
   public $register_requested;
   public $register_tos;
   public $register_tos_i_agree;
   public $register_tos_missing;
   public $register_tos_not_agree;
   public $register_tos_read;
   public $register_what_is;

   public $rssfeed_cannot_find_forum;
   public $rssfeed_cannot_find_topic;
   public $rssfeed_cannot_read_forum;
   public $rssfeed_cannot_read_topic;
   public $rssfeed_error;
   public $rssfeed_forum;
   public $rssfeed_posted_by;
   public $rssfeed_topic;

   public $search_advanced;
   public $search_avatar;
   public $search_basic;
   public $search_characters;
   public $search_day;
   public $search_days;
   public $search_exact_name;
   public $search_flood;
   public $search_for;
   public $search_forum;
   public $search_group;
   public $search_guest;
   public $search_in;
   public $search_in_posts;
   public $search_ip;
   public $search_joined;
   public $search_level;
   public $search_match;
   public $search_matches;
   public $search_month;
   public $search_months;
   public $search_mysqldoc;
   public $search_newer;
   public $search_no_results;
   public $search_no_words;
   public $search_offline;
   public $search_older;
   public $search_online;
   public $search_only_display;
   public $search_partial_name;
   public $search_post_icon;
   public $search_posted_on;
   public $search_posts;
   public $search_posts_by;
   public $search_regex;
   public $search_regex_failed;
   public $search_relevance;
   public $search_replies;
   public $search_result;
   public $search_search;
   public $search_select_all;
   public $search_show_posts;
   public $search_sound;
   ...
   public $settings;
   public $settings_active;
   public $settings_allow;
   public $settings_akismet_api_key_invalid;
   public $settings_akismet_api_key_missing;
   public $settings_akismet_api_key_test;
   public $settings_akismet_api_key_valid;
   public $settings_akismet_email_enable;
   public $settings_akismet_email_enable_msg;
   public $settings_akismet_posts_enable;
   public $settings_akismet_posts_enable_msg;
   public $settings_akismet_posts_number;
   public $settings_akismet_profiles_enable;
   public $settings_akismet_profiles_enable_msg;
   public $settings_akismet_ureg_enable;
   public $settings_akismet_ureg_enable_msg;
   public $settings_akismet_sigs_enable;
   public $settings_akismet_sigs_enable_msg;
   public $settings_antibot;
   public $settings_attach_ext;
   public $settings_attach_one_per;
   public $settings_avatar;
   public $settings_avatar_max_height;
   public $settings_avatar_max_width;
   public $settings_avatar_upload;
   public $settings_basic;
   public $settings_blank;
   public $settings_board_enabled;
   public $settings_board_location;
   public $settings_board_name;
   public $settings_board_rss;
   public $settings_board_rssfeed_desc;
   public $settings_board_rssfeed_posts;
   public $settings_board_rssfeed_time;
   public $settings_board_rssfeed_title;
   public $settings_captcha_pair;
   public $settings_captcha_added;
   public $settings_captcha_answer;
   public $settings_captcha_delete;
   public $settings_captcha_deleted;
   public $settings_captcha_display;
   public $settings_captcha_edit;
   public $settings_captcha_edited;
   public $settings_captcha_invalid;
   public $settings_captcha_missing;
   public $settings_captcha_new_answer;
   public $settings_captcha_new_question;
   public $settings_captcha_no_pair;
   public $settings_captcha_question;
   public $settings_cookie;
   public $settings_cookie_domain;
   public $settings_cookie_path;
   public $settings_cookie_prefix;
   public $settings_cookie_secure;
   public $settings_cookie_secured;
   public $settings_cookie_time;
   public $settings_default_lang;
   public $settings_default_no;
   public $settings_default_skin;
   public $settings_default_yes;
   public $settings_disabled;
   public $settings_disabled_notice;
   public $settings_edit_post_age;
   public $settings_email;
   public $settings_email_fake;
   public $settings_email_from;
   public $settings_email_place1;
   public $settings_email_place2;
   public $settings_email_place3;
   public $settings_email_real;
   public $settings_email_reply;
   public $settings_email_smtp;
   public $settings_email_valid;
   public $settings_enabled;
   public $settings_files;
   public $settings_file_approval;
   public $settings_front_page_links;
   public $settings_general;
   public $settings_google_id;
   public $settings_google_msg;
   public $settings_group_after;
   public $settings_hot_topic;
   public $settings_kilobytes;
   public $settings_left_sidebar;
   public $settings_max_attach_size;
   public $settings_members;
   public $settings_meta_keywords;
   public $settings_meta_description;
   public $settings_mobile_icons;
   public $settings_mobile_icons_desc;
   public $settings_mobile_icons_details;
   public $settings_new;
   public $settings_new_add;
   public $settings_new_added;
   public $settings_new_array;
   public $settings_new_exists;
   public $settings_new_name;
   public $settings_new_required;
   public $settings_new_value;
   public $settings_no_allow;
   public $settings_nodata;
   public $settings_one_per;
   public $settings_pixels;
   public $settings_pm_flood;
   public $settings_pm_min_time;
   public $settings_polls;
   public $settings_polls_no;
   public $settings_polls_yes;
   public $settings_post_flood;
   public $settings_post_min_time;
   public $settings_posts_topic;
   public $settings_registrations;
   public $settings_right_sidebar;
   public $settings_search_flood;
   public $settings_search_min_time;
   public $settings_security;
   public $settings_security_caution;
   public $settings_security_test;
   public $settings_security_csp;
   public $settings_security_csp_detail;
   public $settings_security_csp_warning;
   public $settings_security_fp;
   public $settings_security_fp_detail;
   public $settings_security_fp_warning;
   public $settings_security_htts;
   public $settings_security_htts_detail;
   public $settings_security_htts_max_age;
   public $settings_security_htts_warning;
   public $settings_security_xcto;
   public $settings_security_xcto_detail;
   public $settings_security_xcto_explain;
   public $settings_security_xfo;
   public $settings_security_xfo_deny;
   public $settings_security_xfo_detail;
   public $settings_security_xfo_frames;
   public $settings_security_xfo_same;
   public $settings_server;
   public $settings_server_timezone;
   public $settings_show_avatars;
   public $settings_show_email;
   public $settings_show_emojis;
   public $settings_show_notice;
   public $settings_show_pm;
   public $settings_show_sigs;
   public $settings_spider_agent;
   public $settings_spider_agent_msg;
   public $settings_spider_enable;
   public $settings_spider_enable_msg;
   public $settings_spider_name;
   public $settings_spider_name_msg;
   public $settings_timezone;
   ...
   public $settings_wordpress_msg;

   public $skins_dir;
   public $skins_confirm_disable;
   public $skins_disable;
   public $skins_disable_skin;
   public $skins_disabled;
   public $skins_enable;
   public $skins_enabled;
   public $skins_enable_skin;
   public $skins_invalid_option;
   public $skins_is_disabled;
   public $skins_is_enabled;
   public $skins_manage_skins;
   public $skins_must_select;
   public $skins_name;
   public $skins_no_disable_default;
   public $skins_cant_disable;

   public $spam_action;
   public $spam_all_deleted;
   public $spam_author;
   public $spam_clear_all;
   public $spam_control;
   public $spam_controls;
   public $spam_deleted;
   public $spam_false_positive;
   public $spam_invalid_option;
   public $spam_message1;
   public $spam_message2;
   public $spam_no_post;
   public $spam_no_view;
   public $spam_not_spam;
   public $spam_text;

   public $stats;
   public $stats_false_neg;
   public $stats_false_pos;
   public $stats_forum_posts;
   public $stats_post_by_month;
   public $stats_prof;
   public $stats_reg;
   public $stats_reg_by_month;
   public $stats_sig;
   public $stats_spam_statistics;

   public $titles_add;
   public $titles_added;
   public $titles_control;
   public $titles_edit;
   public $titles_error;
   public $titles_image;
   public $titles_minpost;
   public $titles_nodel_default;
   public $titles_title;

   public $topic_attached;
   ...
   public $topic_avatar;
   public $topic_bottom;
   public $topic_create_poll;
   public $topic_create_topic;
   public $topic_delete;
   public $topic_delete_post;
   public $topic_delete_spam;
   public $topic_edit;
   public $topic_edit_post;
   public $topic_edited;
   public $topic_error;
   public $topic_group;
   public $topic_guest;
   ...
   public $topic_joined;
   public $topic_level;
   public $topic_links_email;
   public $topic_links_facebook;
   public $topic_links_twitter;
   public $topic_links_pm;
   public $topic_links_web;
   public $topic_lock;
   public $topic_locked;
   public $topic_move;
   public $topic_new_post;
   public $topic_newer;
   public $topic_no_newer;
   public $topic_no_older;
   public $topic_no_votes;
   public $topic_not_found;
   public $topic_not_found_message;
   public $topic_offline;
   public $topic_older;
   public $topic_online;
   public $topic_options;
   public $topic_pages;
   public $topic_perm_view;
   public $topic_perm_view_guest;
   public $topic_pin;
   public $topic_posted;
   public $topic_posts;
   public $topic_print;
   public $topic_publish;
   public $topic_qr_emojis;
   public $topic_quickreply;
   public $topic_quote;
   public $topic_reply;
   public $topic_split;
   public $topic_split_finish;
   public $topic_split_keep;
   public $topic_split_move;
   public $topic_subscribe;
   public $topic_top;
   public $topic_unlock;
   public $topic_unpin;
   public $topic_unpublish;
   public $topic_unpublished;
   public $topic_unreg;
   public $topic_view;
   public $topic_viewing;
   public $topic_vote;
   public $topic_vote_count_plur;
   public $topic_vote_count_sing;
   public $topic_votes;
   ...
   public function active()
	...
	public function cp()
	{
		...
		$this->cp_custom_title2 = 'This is a privilege reserved for board administrators';
	...
	public function files()
	{
      ...
      $this->files_invalid_user = 'An invalid user ID was entered. Please check the URL.';
		...
		$this->files_search_error = 'You have to search by at least the name, author or description.';
	...
	public function page()
	{
		...
		$this->page_delete_confirm = 'Are you sure you want to delete this page forever? This process is irreversible.';
	...
	public function rssfeed()
	{
		...
		$this->rssfeed_cannot_find_topic = 'The topic does not appear to exist';
	...
	public function settings()
	{
      ...
      $this->settings_akismet_api_key_valid = 'Your Akismet API Key is valid.';
		...
		$this->settings_security_xcto_explain = 'Enabling this option blocks CSS requests for types other than text/css and Script requests for unrecognized Javascript MIME types.';
	...
	public function topic()
	{
      ...
      $this->topic_attached_invalid = 'The attachment you are trying to download does not exist.';
		...
		$this->topic_links_pm = 'Send a personal message to %s';
	...
	public function universal()
	{
		...
		$this->gmt_pos04  = 'GMT+4     - Asia: Oman/United Arab Emirates';
		...
		$this->gmt_pos08  = 'GMT+8     - Asia: China/Mongolia/Philippines';
