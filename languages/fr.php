...
class fr
{
	...
	function admin()
	{
		...
		$this->admin_heading = 'Panneau de contrôle administratif de QSF Portal';
	...
	function backup()
	{
		...
		$this->backup_done = 'La base de données a été reculée à l\'annuaire QSF Portal principal. ';
		$this->backup_download = 'Backup and download (recommended)'; //Translate
		$this->backup_failed = 'Failed to create backup.'; //Translate
		$this->backup_found = 'Les sauvegardes suivantes ont été trouvées dans l\'annuaire de QSF Portal';
		...
		$this->backup_none = 'Aucune sauvegarde n\'a été trouvée dans l\'annuaire de QSF Portal.';
	...
	function groups()
	{
		...
		$this->groups_no_delete = 'Il n\'y a aucun groupe personalisé à supprimer.<br />Les groupes centraux sont ncessaires pour que QSF Portal puisse fonctionner, et ainsi ne peuvent être supprimés.';
	...
	function member_control()
	{
		...
		$this->mc_guest_needed = 'Le compte invité est nécessaire pour que QSF Portal puisse fonctionner.';
	...
	function register()
	{
		...
		$this->register_email_msg = 'Ceci est un mél généré automatiquement par QSF Portal, et envoyé à vous pour';
