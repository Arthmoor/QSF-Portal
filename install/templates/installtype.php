    ...
    <tr>
        ...
        <td><label for='install'>New QSF Portal installation</label></td>
    </tr>
    <tr>
        <td><input id='upgrade' type='radio' name='mode' value='upgrade' /></td>
        <td><label for='upgrade'>Upgrade from a previous QSF Portal, Quicksilver Forums, or MercuryBoard version</label></td>
    </tr>
    <tr>
